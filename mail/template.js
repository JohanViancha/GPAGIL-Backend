...
const templateEmail = (type, content)=>{
  ...
  switch(type){
    case 'verify':
      title = 'Tu solicitud de recuperación de la cuenta',
      contentEmail ={
        name: `${content.name_user} ${content.lastname_user}`,
        idUser: content.idUser,
        listFunctions:'',
        text: 'Hola, te damos la bienvenida a GPAGIL, estamos muy emocionados que hayas decidido iniciar con nosotros. Para continuar necesitamos tu confirmación de la cuenta. Presiona el botón de "Verificar cuenta',
        link: `<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="${process.env.urlFrontend}/verify/${content.idUser}" target="_blank">Verificar cuenta</a>`
      }
    break;
    ...
    case 'recovery':
      ...
      contentEmail ={
        ...
        idUser: '',
        listFunctions:'',
        text: 'Hola, hemos recibido tu solicitud para recuperar tu contraseña. Se ha generado un codigo de 6 digitos el cual debes ingresar en la plataforma para hacer el cambio de tu contraseña',
        link:`<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="#" target="_blank">${content?.codeRandom}</a>
        `
      }
    break;
                                ...
                                <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                  <tr>
                                    <td align="center" valign="top" class="textContent">
                                      ...
                                      <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#FFF;line-height:135%;">${title}</h2>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                          <td valign="top" class="textContent">
                                            <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">${contentEmail?.name}</h3>
                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">${contentEmail?.text}
                                            ${contentEmail?.listFunctions}
                                            </div>
                                          </td>
                                        </tr>
                                      </table>
