                                            ...
                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                              <tr>
                                                <td align="center" valign="top" class="textContent">
                                                  ...
                                                  <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#FFF;line-height:135%;">Asignación del proyecto</h2>
                                                </td>
                                              </tr>
                                            </table>
                                          </td>
                                                  ...
                                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                      <td valign="top" class="textContent">                                                   
                                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Hola, has sido elegido como el líder del proyecto ${nameProject}. Recuerda que tus funciones son:
                                                            <li>Gestionar tareas relacionadas a este proyecto</li>
                                                            <li>Comunicación activa con los integrantes de tu equipo</li>
                                                            <li>Asignación y seguimiento de cada una de las tareas</li>
                                                        </div>
                                                      </td>
                                                    </tr>
                                                  </table>
